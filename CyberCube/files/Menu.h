...
public:
	...
	void run() {
		...
		// текстуры
		btn_1_Texture.loadFromFile("img/Игра.png");
		btn_2_Texture.loadFromFile("img/Правила.png");
		btn_3_Texture.loadFromFile("img/Выход.png");
		rules_Texture.loadFromFile("img/Текст_правила.png");
		menu_Background.loadFromFile("img/Background(800, 600).png");
